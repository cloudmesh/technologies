...
* Using a dynamic selection methodology that estimates and chooses an appropriate test dataset based on query’s precision requirement as well as reaction time necessities.
