...
In traditional IT infrastructure resource scaling is a cumbersome task 
...
This technology features on-demand elastic cloud computing capabilities 
such as *Amazon EC2*. Apache CloudStack has a rich management interface 
...
or VM, in an Apache Tomcat container and requires a *MySQL* database for 
persistence. The deployment architecture consists of a *hypervisor*
...
The *basic* configuration resembles more to a classic AWS-style networking 
while the *advanced* configuration typically uses layer-2 isolation.
[@www-cloudstackconcept]. 

Today, Apache CloudStack services are used by a wide variety of users 
including Apple, Bell Canada, Zynga, Huawei. Many of those users 
...
the announcement was released on on March 25, 2013 [@www-cloudstackhistory].
