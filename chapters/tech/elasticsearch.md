...
Elasticsearch is a distributed RESTful search engine built for the cloud[3]. The distributed search and analytics engine built on Apache Lucene[@fa18-523-70-elasticsearch]. 
